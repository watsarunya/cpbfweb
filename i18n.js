...
(function () {
  ...
  function applyLang(lang) {
    ...
    // ⚠️ เพิ่ม 2026-08-04: สลับ src ของ <img>/<video> — ใช้โดย Hero/KV Banner (banner-render.js) เพื่อสลับรูป/
    // วิดีโอ TH↔EN ตอนเปลี่ยนภาษา (เดิม banner-render.js เผลอใช้ data-th/data-en เฉยๆ ซึ่งเป็น convention
