...
(function () {
  ...
  function buildDropdownItem(item, children) {
    ...
    if (withImages.length > 0) {
      gallery = el('div', { class: 'nav-dropdown__gallery' });
    ...
    var megaInner = el('div', { class: 'nav-dropdown__mega-inner' }, [list, gallery]);
    var dropdown = el('div', { class: 'nav-dropdown nav-dropdown--mega' }, [megaInner]);
    return el('li', { class: 'has-dropdown has-dropdown--mega' }, [trigger, dropdown]);
  }
